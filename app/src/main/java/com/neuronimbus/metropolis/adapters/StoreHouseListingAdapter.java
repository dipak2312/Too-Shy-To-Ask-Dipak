...
public class StoreHouseListingAdapter extends RecyclerView.Adapter<StoreHouseListingAdapter.ViewHolder> {
    ...
    public StoreHouseListingAdapter(Context context, ArrayList<com.neuronimbus.metropolis.Models.StoreHouse.CategoryData.data> data, OnBookmarkClicked onBookmarkClicked) {
