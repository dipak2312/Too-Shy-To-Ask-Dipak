...
public class RecentlyBlogAdapter extends RecyclerView.Adapter<RecentlyBlogAdapter.ViewHolder>{
    Context context;
    ArrayList<com.neuronimbus.metropolis.Models.Blogs> Blogs;
    boolean like = true;
    SPManager spManager;
    OnBookmarkClicked onBookmarkClicked;

    public RecentlyBlogAdapter(Context context, ArrayList<com.neuronimbus.metropolis.Models.Blogs> blogs, SPManager spManager, OnBookmarkClicked onBookmarkClicked) {
