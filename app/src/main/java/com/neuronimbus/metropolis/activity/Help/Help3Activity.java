...
public class Help3Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    ArrayList<com.neuronimbus.metropolis.Models.Help.helpcontent> helpcontent;
    ...
    TextInputLayout description_enter;
        ...
        switch (view.getId()){
            case R.id.radio_btn:
                if(isChecked){
                    ...
                    description_enter.setVisibility(View.GONE);
                }
                break;
            ...
            case R.id.radio_btn4:
                if(isChecked){
                    ...
                    radio_btn3.setTextColor(ContextCompat.getColor(context, R.color.black));
                    radio_btn.setTextColor(ContextCompat.getColor(context, R.color.black));
                    description_enter.setVisibility(View.VISIBLE);
                }
        }
    }
