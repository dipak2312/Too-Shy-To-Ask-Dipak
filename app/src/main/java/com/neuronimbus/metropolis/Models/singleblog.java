...
public class singleblog {
    ...
    public ArrayList<com.neuronimbus.metropolis.Models.comments> getComments() {
        return comments;
    }

    public void setComments(ArrayList<com.neuronimbus.metropolis.Models.comments> comments) {
