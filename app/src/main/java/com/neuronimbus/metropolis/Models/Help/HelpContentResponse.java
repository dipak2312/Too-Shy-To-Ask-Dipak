...
public class HelpContentResponse {
    ...
    public ArrayList<com.neuronimbus.metropolis.Models.Help.helpcontent> getHelpcontent() {
        return helpcontent;
    }

    public void setHelpcontent(ArrayList<com.neuronimbus.metropolis.Models.Help.helpcontent> helpcontent) {
