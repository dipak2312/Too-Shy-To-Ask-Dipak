...
public class BlogCommentsReplyAdapter extends RecyclerView.Adapter<BlogCommentsReplyAdapter.allcommentViewHolder> {
    ...
    Context context;
    ArrayList<com.example.tooshytoask.Models.child_comment>child_comment;

    public BlogCommentsReplyAdapter(Context context, ArrayList<com.example.tooshytoask.Models.child_comment> child_comment) {
    ...
    public void setData(ArrayList<com.example.tooshytoask.Models.child_comment>child_comment){
        this.child_comment=child_comment;
