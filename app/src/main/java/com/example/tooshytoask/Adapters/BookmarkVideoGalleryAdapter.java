...
import com.example.tooshytoask.Models.videobookmarks;
...
public class BookmarkVideoGalleryAdapter extends RecyclerView.Adapter<BookmarkVideoGalleryAdapter.ViewHolder> {
    ...
    public BookmarkVideoGalleryAdapter(Context context, ArrayList<com.example.tooshytoask.Models.videobookmarks> videobookmarks) {
