...
import com.example.tooshytoask.Models.Courses.LMSQuiz.Option;
import com.example.tooshytoask.R;

import java.util.ArrayList;

public class LMSOptionAdapter extends RecyclerView.Adapter<LMSOptionAdapter.optionviewholder> {


    Context context;
    ArrayList<com.example.tooshytoask.Models.Courses.LMSQuiz.Option>optionList;
    private int selectedPos = -1;
    private IOnClick iOnClick;

    public LMSOptionAdapter(Context context, ArrayList<Option> optionList, IOnClick iOnClick) {
