...
public class CustomProgressDialog extends Dialog {
    ...
    com.example.tooshytoask.Utils.CustomProgressDialog dialog;
    ...
    public com.example.tooshytoask.Utils.CustomProgressDialog show(CharSequence message) {
    ...
    public com.example.tooshytoask.Utils.CustomProgressDialog dismiss(CharSequence message) {
        if (dialog != null) {
            dialog.dismiss();
        }
